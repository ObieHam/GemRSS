        ...
        textContent.items.forEach((item) => {
          ...
          tokens.forEach(token => {
            ...
            if (isWord) {
              ...
              span.addEventListener('mouseenter', () => { if (!isSaved) span.style.backgroundColor = 'rgba(212, 175, 55, 0.3)'; });
              span.addEventListener('mouseleave', () => { if (!isSaved) span.style.backgroundColor = isNewWord ? 'rgba(212, 175, 55, 0.15)' : 'transparent'; });
